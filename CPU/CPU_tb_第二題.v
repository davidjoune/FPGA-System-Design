...
module CPU_tb;
   ...
   initial begin
		...
		write_mem(16'h3,16'b0000_0011_0010_1000);  // ADD R3,R1,R2
		write_mem(16'h4,16'b0010_1011_0000_0010);  // STR R3,R0,#2 (16'h27 = 55H)
		write_mem(16'h5,16'b0001_1100_0000_0010);  // LDR R4,R0,#2
		write_mem(16'h6,16'b1110_0000_1000_0000);  // OUT R4 (55H)
		write_mem(16'h7,16'b1110_0000_0000_0001);  // HLT
		
		write_mem(16'h25,16'h22);// data (25h, 22h)
		write_mem(16'h26,16'h33);// data (26h, 33h)
